...
void __init sun8i_reserve(void)
{
	...
	/* If defined ION_SUNXI_CARVEOUT_OVERRIDE, then override
	 * the definition from command line.
	 */
#ifdef CONFIG_ION_SUNXI_CARVEOUT_OVERRIDE
	sun8i_ion_reserve_override();
#endif
